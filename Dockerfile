...
RUN mkdir -p ${GRAYLOG_HOME}/data/journal ${GRAYLOG_HOME}/data/log ${GRAYLOG_HOME}/data/plugin ${GRAYLOG_HOME}/data/config ${GRAYLOG_HOME}/data/contentpacks
...
RUN chmod -R 775 ${GRAYLOG_HOME}/data
